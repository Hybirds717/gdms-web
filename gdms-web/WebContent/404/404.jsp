...
<META http-equiv=refresh content="10;URL = http://www.pc6.com/">
...
<TABLE height=382 cellSpacing=0 cellPadding=0 width=470 align=center border=0>
  ...
  <TR>
    <TD vAlign=top 
    background="images/404/bg.gif"><BR>
        ...
        <TR>
          ...
          <TD>
            ...
            border=0>
              <TBODY>
              <TR>
                <TD>NND，你谁把我的页给删除了。害得你不能访问这个页了。</TD></TR>
              <TR>
                <TD>
                  <LI>赶快访问<A href="http://www.pc6.com/"><FONT 
                  color=#990000></FONT></A></LI></TD></TR>
              <TR>
                <TD>
                  <LI>本站空间由<A href="http://www.pc6.com/"><FONT 
                  color=#990000>pc6下载站</FONT></A>提供！在这里感谢一下！不知道能不能看到！</LI></TD></TR>
              <TR>
                <TD>
                  <LI>我们定于10秒钟之后自动引爆炸弹，你不跑还呆着啊！</LI></TD></TR></TBODY></TABLE><BR></DIV></TD></TR></TBODY></TABLE>
      <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
        <TBODY>
        <TR>
          <TD width="38%">&nbsp;</TD>
          <TD width="17%">
            <DIV align=right><A href="http://www.pc6.com/"><IMG height=38 
            src="images/404/jt.gif" width=56 
            border=0></A></DIV></TD>
          <TD width="45%">
            <DIV align=center><A href="http://www.pc6.com/"><FONT 
